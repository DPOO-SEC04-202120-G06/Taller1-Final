...
public class ConsolaHamburguesas {
	...
	private ArrayList<Ingrediente> ejecutarCargarIngredientes(String rutaArchivo)
	{
		ArrayList<Ingrediente> Ingredientes = new ArrayList<Ingrediente>();
		try
		{
			Ingredientes = LoaderInformacionArchivos.leerInfoArchivoIngredientes(rutaArchivo);
			System.out.println("OK Se cargó el archivo " + rutaArchivo + " con información de los Productos Menu.");
		}
		catch (FileNotFoundException e)
		{
	...
	public static void main(String[] args) {
		...
		ArrayList<Ingrediente> Ingredientes = consola.ejecutarCargarIngredientes("./data/ingredientes.txt");  // parametros: ruta del archivo ingredientes.txt dentro del proyecto Eclipse
		for (Ingrediente ingrediente : Ingredientes)
		{
		    //System.out.print(ingrediente.getClass());
